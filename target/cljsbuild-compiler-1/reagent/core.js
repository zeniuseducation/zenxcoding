...
var render_component__3 = (function (comp,container,callback){return reagent.core.React.renderComponent(reagent.core.as_component(comp),container,callback);
});
...
*/
reagent.core.render_component_to_string = (function render_component_to_string(component){return reagent.core.React.renderComponentToString(reagent.core.as_component(component));
});
/**
...
var G__5447__delegate = function (x,rest){return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(reagent.ratom.atom,x,rest);
};
var G__5447 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__5447__delegate.call(this,x,rest);};
G__5447.cljs$lang$maxFixedArity = 1;
G__5447.cljs$lang$applyTo = (function (arglist__5448){
var x = cljs.core.first(arglist__5448);
var rest = cljs.core.rest(arglist__5448);
return G__5447__delegate(x,rest);
});
...
*/
reagent.core.next_tick = (function next_tick(f){return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(f) : reagent.impl.batching.next_tick.call(null,f));
});
/**
...
partial.cljs$lang$applyTo = (function (arglist__5449){
var f = cljs.core.first(arglist__5449);
