...
reagent.impl.batching.next_tick = ((cljs.core.not(reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3560__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__3560__auto__))
{return or__3560__auto__;
} else
{var or__3560__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__3560__auto____$1))
{return or__3560__auto____$1;
} else
{var or__3560__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__3560__auto____$2))
{return or__3560__auto____$2;
} else
{var or__3560__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__3560__auto____$3))
...
var n__4416__auto__ = a.length;var i = (0);while(true){
if((i < n__4416__auto__))
{var C_5466 = (a[i]);if(cljs.core.truth_(C_5466.cljsIsDirty))
{C_5466.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write(writer__4128__auto__,"reagent.impl.batching/RenderQueue");
});
...
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(((function (this$){
return (function (){return this$.run_queue();
});})(this$))
) : reagent.impl.batching.next_tick.call(null,((function (this$){
return (function (){return this$.run_queue();
});})(this$))
));
}
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__3548__auto__ = !((C == null));if(and__3548__auto__)
{var and__3548__auto____$1 = (C["props"]);if(cljs.core.truth_(and__3548__auto____$1))
...
{C.cljsRatom = reagent.ratom.make_reaction.cljs$core$IFn$_invoke$arity$variadic(run,cljs.core.array_seq([cljs.core.constant$keyword$50,((function (res,derefed,rat){
return (function (){return reagent.impl.batching.queue_render(C);
});})(res,derefed,rat))
,cljs.core.constant$keyword$47,derefed], 0));
} else
{}
return res;
} else
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_5468 = C.cljsRatom;if(!((ratom_5468 == null)))
{reagent.ratom.dispose_BANG_(ratom_5468);
} else
{}
